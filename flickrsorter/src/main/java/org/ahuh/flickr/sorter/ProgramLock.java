...
public class ProgramLock {
	 ...
	 * Logger
	 */
	private static Logger log = Logger.getLogger(ProgramLock.class);
	
    private static File f;
    private static FileChannel channel;
    private static FileLock lock;
     
    public ProgramLock() throws Exception
    {
        try
        {
        	URL resourceURL = ProgramLock.class.getResource("/");
            f = new File(URLDecoder.decode(resourceURL.getFile(), "UTF-8") + "FlickrSorter.lock");
